 ...
 * Compile with:
 *
 * gcc -fPIC -ffunction-sections -fdata-sections -march=armv7-a -Os -pipe -g3 -mthumb frida-gum-example.c -o frida-gum-example -L. -lfrida-gum -ldl -lresolv -lm -Wl,--gc-sections,-z,noexecstack -static-libgcc
 *
